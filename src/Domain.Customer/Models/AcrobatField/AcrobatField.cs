...
{
    public class AcrobatField : IdentityModel<string>, IDocument
    {
        ...
        public virtual ICollection<AcrobatFieldContentBox> ContentBoxes { get; set; } = new List<AcrobatFieldContentBox>();
