...
{
    public class AcrobatFieldCloneCommandHandler : ICommandHandlerAndValidator<CloneCommand<AcrobatField>>
    {
        ...
        public AcrobatFieldCloneCommandHandler(IQueryExecutor queryExecutor,
        ...
        public CommandResponse Execute(CloneCommand<AcrobatField> command)
        {
        ...
        private CreateOrUpdateAcrobatFieldCommand Clone(AcrobatField e, IList<UploadContentCloneMapping> uploadCloneMappings, string title, string oldDocId = "")
        {
            var command = new CreateOrUpdateAcrobatFieldCommand
            {
        ...
        public IEnumerable<IValidationResult> Validate(CloneCommand<AcrobatField> command)
        {
